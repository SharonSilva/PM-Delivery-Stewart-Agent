"""
Bonus golden case (beyond the brief's 9 required cases): every
quantitative claim in the weekly report is reproducible from the
stored snapshots, and the scope-change section correctly identifies
...
def golden_case_bonus_weekly_report():
